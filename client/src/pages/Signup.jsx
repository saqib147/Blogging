        ...
        <div className="p-8 sm:p-12 flex flex-col justify-between bg-surface">
          <div className="my-auto space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button type="submit" variant="secondary" className="w-full py-3 mt-4 justify-center font-semibold text-sm cursor-pointer" disabled={loading}>
                {loading ? 'Creating account...' : 'Create Account'} <span className="ml-1.5">→</span>
              </Button>
            </form>
            ...
            <p className="text-sm text-neutral-body/60 text-center pt-2">
              ...
              <Link to="/login" className="text-neutral-heading font-semibold hover:underline decoration-1 underline-offset-4">
                Sign in
              </Link>
            </p>
          </div>
